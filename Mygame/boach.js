let board = {
    writeBoard: function(){
        ...
        for(let i=0; i < currGame.noOfRow; i++){
            st += '<tr>';
            for(let j=0; j < currGame.noOfCol; j++){
    ...
    sqUpdate: function(i,j){
        let OHtml='<img src="https://res.cloudinary.com/wegoup/image/upload/v1589459651/yy0srvt5ifsa4loswzrq.png">';
        let XHtml='<img src="https://res.cloudinary.com/wegoup/image/upload/v1589459679/ngw2r389uayfaga8otna.png">';
    ...
    sqMouseOver: function(row, col) {
        if (currGame.isGamming && currGame.sq[row][col] == 0 && currGame.Turn == X) {
            let HTML='<img style="opacity: 0.5" src="https://res.cloudinary.com/wegoup/image/upload/v1589459679/ngw2r389uayfaga8otna.png">';
